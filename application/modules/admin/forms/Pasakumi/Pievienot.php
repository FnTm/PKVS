<?php
class Admin_Form_Pasakumi_Pievienot extends Zend_Form
{
    ...
    public function __construct($option = null)
    {
        ...
        $this->addElement($this->createElement('text', 'pasakumsTime')->setLabel('Pasākuma norises datums un laiks'));
        $this->addElement($this->createElement('file', 'pasakumsImage')->setLabel('Pasākuma logo')->setRequired(TRUE));
