...
class Model_AuthAcl extends Zend_Acl
{
    public function __construct ()
    {
        ...
        $this->add(new Zend_Acl_Resource('admin'))
            ...
            ->add(new Zend_Acl_Resource('admin:pasakumi'), 'admin')
            ->add(new Zend_Acl_Resource('admin:krutums'), 'admin')
            ->add(new Zend_Acl_Resource('admin:jaunumu-kategorijas'), 'admin')
            ->add(new Zend_Acl_Resource('admin:menu'), 'admin')
            ->add(new Zend_Acl_Resource('admin:pasakuma-tipi'), 'admin')
            ->add(new Zend_Acl_Resource('admin:apmekletiba-tips'), 'admin')
            ->add(new Zend_Acl_Resource('admin:apmekletiba'), 'admin')
            ->add(new Zend_Acl_Resource('admin:user'), 'admin')
        ->add(new Zend_Acl_Resource('admin:maksajumi'), 'admin');
